...
namespace UnityEngine.Rendering.Universal
{
    ...
    /// </summary>
    public sealed class CustomShadowCasterRenderer : ScriptableRenderer
    {
        const int k_DepthStencilBufferBits = 32;

        private static class Profiling
        {
            private const string k_Name = nameof(CustomShadowCasterRenderer);
...
#pragma warning restore 414
        ...
        public CustomShadowCasterRenderer(CustomShadowCasterRendererData data) : base(data)
        {
#if ENABLE_VR && ENABLE_XR_MODULE
            ...
            ShaderTagId[] ShaderTagIds = new ShaderTagId[] {
                    new ShaderTagId("ProjectorShadowCaster"),
                 
                };
            // Always create this pass even in deferred because we use it for wireframe rendering in the Editor or offscreen depth texture rendering.
            m_RenderOpaqueForwardPass = new DrawObjectsPass("ProjectorShadowCaster", ShaderTagIds, true, RenderPassEvent.BeforeRenderingOpaques, RenderQueueRange.opaque, data.opaqueLayerMask, m_DefaultStencilState, stencilData.stencilReference);
...
#endif
                ConfigureCameraTarget(activeColorRenderTargetId, new RenderTargetIdentifier());
            }
