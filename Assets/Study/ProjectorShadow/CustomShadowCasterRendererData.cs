...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class CustomShadowCasterRendererData : ScriptableRendererData
    {
#if UNITY_EDITOR
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1812")]
        internal class CreateCustomShadowCasterRendererAsset : EndNameEditAction
        {
            public override void Action(int instanceId, string pathName, string resourceFile)
            {
                var instance = CreateInstance<CustomShadowCasterRendererData>();
        ...
        [MenuItem("Assets/Create/Rendering/Universal Render Pipeline/CustomShadowCasterRenderer", priority = CoreUtils.assetCreateMenuPriority2)]
        static void CreateCustomShadowCasterRendererData()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateCustomShadowCasterRendererAsset>(), "CustomShadowCasterRendererData.asset", null, null);
        }
#endif
...
#endif
            return new CustomShadowCasterRenderer(this);
        }
